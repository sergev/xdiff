...
#define XDL_UNUSED \
    __attribute__((unused)) __attribute__((deprecated("parameter declared as UNUSED")))
#elif defined(__GNUC__)
#define XDL_UNUSED __attribute__((unused)) __attribute__((deprecated))
#else
#define XDL_UNUSED
#endif
...
static inline int xdl_regexec_buf(const xdl_regex_t *preg, const char *buf, size_t size,
